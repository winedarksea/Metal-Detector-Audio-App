    ...
    fun parse(raw: String): List<RecordingMetadata> {
        ...
        rows.drop(1).forEach { row ->
            ...
            val labelClass = if (hasObjectLevelClasses) {
                ...
                // Existing app datasets are known to contain AMBIENT-only recordings.
                ClassLabel.AMBIENT
            }
            ...
            val metadataRow = MutableMetadataRow(
                ...
                audioProfile = blankToNull(valueFor(header, row, "audio_profile")),
