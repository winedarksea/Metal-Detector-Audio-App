 ...
 *
 * ONNX model I/O:
 *   Input:  "log_mel_spectrogram" [1, 61, 40, 1] float32
...
class DesktopOnnxClassifier(
    ...
    // Expected tensor dimensions from the trained model
    private val expectedTimeFrames = 61
    private val expectedMelBins = 40
